; ModuleID = '/users/ugrad/chungmop/hls-practice/fft_baseline/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: noinline
define void @apatb_fft_streaming_ir(float* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="1024" %X_R, float* noalias nocapture nonnull readonly "fpga.decayed.dim.hint"="1024" %X_I, float* noalias nocapture nonnull "fpga.decayed.dim.hint"="1024" %OUT_R, float* noalias nocapture nonnull "fpga.decayed.dim.hint"="1024" %OUT_I) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_fft_streaming_hw(float* %4, float* %5, float* %6, float* %7)
...
declare void @apatb_fft_streaming_hw(float*, float*, float*, float*)
...
define void @fft_streaming_hw_stub_wrapper(float*, float*, float*, float*) #4 {
entry:
  ...
  call void @fft_streaming_hw_stub(float* %8, float* %9, float* %10, float* %11)
...
declare void @fft_streaming_hw_stub(float*, float*, float*, float*)
