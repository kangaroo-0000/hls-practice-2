...
// wrapc file define:
#define AUTOTB_TVIN_X_R "../tv/cdatafile/c.fft_streaming.autotvin_X_R.dat"
#define AUTOTB_TVOUT_X_R "../tv/cdatafile/c.fft_streaming.autotvout_X_R.dat"
#define AUTOTB_TVIN_X_I "../tv/cdatafile/c.fft_streaming.autotvin_X_I.dat"
#define AUTOTB_TVOUT_X_I "../tv/cdatafile/c.fft_streaming.autotvout_X_I.dat"
#define AUTOTB_TVIN_OUT_R "../tv/cdatafile/c.fft_streaming.autotvin_OUT_R.dat"
#define AUTOTB_TVOUT_OUT_R "../tv/cdatafile/c.fft_streaming.autotvout_OUT_R.dat"
#define AUTOTB_TVIN_OUT_I "../tv/cdatafile/c.fft_streaming.autotvin_OUT_I.dat"
#define AUTOTB_TVOUT_OUT_I "../tv/cdatafile/c.fft_streaming.autotvout_OUT_I.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_OUT_R "../tv/rtldatafile/rtl.fft_streaming.autotvout_OUT_R.dat"
#define AUTOTB_TVOUT_PC_OUT_I "../tv/rtldatafile/rtl.fft_streaming.autotvout_OUT_I.dat"
...
extern "C"
void fft_streaming_hw_stub_wrapper(void*, void*, void*, void*);

extern "C"
void apatb_fft_streaming_hw(void* __xlx_apatb_param_X_R, void* __xlx_apatb_param_X_I, void* __xlx_apatb_param_OUT_R, void* __xlx_apatb_param_OUT_I)
{
#ifdef USE_BINARY_TV_FILE
  ...
  static hls::sim::Memory<hls::sim::Reader, hls::sim::Writer> port0 {
    ...
    .owriter = nullptr,
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_X_R),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_X_R),
#endif
#endif
  };
  port0.param = { __xlx_apatb_param_X_R };
  port0.depth = { 1024 };
  port0.offset = {  };
  ...
  static hls::sim::Memory<hls::sim::Reader, hls::sim::Writer> port1 {
    ...
    .owriter = nullptr,
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_X_I),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_X_I),
#endif
#endif
  };
  port1.param = { __xlx_apatb_param_X_I };
  port1.depth = { 1024 };
  port1.offset = {  };
...
#ifdef POST_CHECK
#ifdef USE_BINARY_TV_FILE
    .reader = new hls::sim::Input(AUTOTB_TVOUT_PC_OUT_I),
#else
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_OUT_I),
#endif
#else
#ifdef USE_BINARY_TV_FILE
    .owriter = new hls::sim::Output(AUTOTB_TVOUT_OUT_I),
#else
    .owriter = new hls::sim::Writer(AUTOTB_TVOUT_OUT_I),
#endif
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_OUT_I),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_OUT_I),
#endif
#endif
  };
  port3.param = { __xlx_apatb_param_OUT_I };
  port3.depth = { 1024 };
  port3.offset = {  };
  port3.hasWrite = { true };
  ...
  try {
    ...
    fft_streaming_hw_stub_wrapper(__xlx_apatb_param_X_R, __xlx_apatb_param_X_I, __xlx_apatb_param_OUT_R, __xlx_apatb_param_OUT_I);
