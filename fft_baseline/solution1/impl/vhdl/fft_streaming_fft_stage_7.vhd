...
entity fft_streaming_fft_stage_7 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of fft_streaming_fft_stage_7 is 
...
attribute shreg_extract : string;
    ...
    signal W_real14_address0 : STD_LOGIC_VECTOR (8 downto 0);
    signal W_real14_ce0 : STD_LOGIC;
    signal W_real14_q0 : STD_LOGIC_VECTOR (31 downto 0);
    signal W_imag6_address0 : STD_LOGIC_VECTOR (8 downto 0);
    signal W_imag6_ce0 : STD_LOGIC;
    signal W_imag6_q0 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal mul_reg_476 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_fu_226_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal mul7_reg_481 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_fu_232_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal mul8_reg_486 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_fu_238_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal mul9_reg_491 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal X_R_load_3_reg_524 : STD_LOGIC_VECTOR (31 downto 0);
    signal X_I_load_3_reg_530 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal sub3_reg_541 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal add3_reg_551 : STD_LOGIC_VECTOR (31 downto 0);
    signal zext_ln43_fu_332_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_pp0_stage0 : BOOLEAN;
    signal t_fu_58 : STD_LOGIC_VECTOR (2 downto 0);
    signal add_ln46_fu_370_p2 : STD_LOGIC_VECTOR (2 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_sig_allocacmp_t_load : STD_LOGIC_VECTOR (2 downto 0);
    signal j_fu_62 : STD_LOGIC_VECTOR (7 downto 0);
    signal select_ln43_5_fu_338_p3 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal empty_fu_265_p1 : STD_LOGIC_VECTOR (6 downto 0);
    signal icmp_ln46_fu_292_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal add_ln43_2_fu_306_p2 : STD_LOGIC_VECTOR (7 downto 0);
    signal empty_11_fu_312_p1 : STD_LOGIC_VECTOR (6 downto 0);
    signal p_mid1_fu_316_p3 : STD_LOGIC_VECTOR (8 downto 0);
    signal tmp_5_fu_269_p3 : STD_LOGIC_VECTOR (8 downto 0);
    signal select_ln43_4_fu_324_p3 : STD_LOGIC_VECTOR (8 downto 0);
    signal select_ln43_fu_298_p3 : STD_LOGIC_VECTOR (2 downto 0);
    signal trunc_ln47_fu_346_p1 : STD_LOGIC_VECTOR (1 downto 0);
...
begin
    W_real14_U : component fft_streaming_fft_stage_1_W_real_ROM_AUTO_1R
    generic map (
        DataWidth => 32,
        AddressRange => 512,
        AddressWidth => 9)
    port map (
        clk => ap_clk,
        reset => ap_rst,
        address0 => W_real14_address0,
        ce0 => W_real14_ce0,
        q0 => W_real14_q0);

    W_imag6_U : component fft_streaming_fft_stage_1_W_imag_ROM_AUTO_1R
    generic map (
        DataWidth => 32,
        AddressRange => 512,
        AddressWidth => 9)
    port map (
        clk => ap_clk,
        reset => ap_rst,
        address0 => W_imag6_address0,
        ce0 => W_imag6_ce0,
        q0 => W_imag6_q0);

    fsub_32ns_32ns_32_3_full_dsp_1_U106 : component fft_streaming_fsub_32ns_32ns_32_3_full_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 3,
        din0_WIDTH => 32,
    ...
    fadd_32ns_32ns_32_3_full_dsp_1_U107 : component fft_streaming_fadd_32ns_32ns_32_3_full_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 3,
        din0_WIDTH => 32,
    ...
    fsub_32ns_32ns_32_3_full_dsp_1_U108 : component fft_streaming_fsub_32ns_32ns_32_3_full_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 3,
        din0_WIDTH => 32,
    ...
    port map (
        clk => ap_clk,
        reset => ap_rst,
        din0 => X_R_load_3_reg_524,
        din1 => temp_R_reg_512,
        ce => grp_fu_204_ce,
        dout => grp_fu_204_p2);

    fsub_32ns_32ns_32_3_full_dsp_1_U109 : component fft_streaming_fsub_32ns_32ns_32_3_full_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 3,
        din0_WIDTH => 32,
    ...
    port map (
        clk => ap_clk,
        reset => ap_rst,
        din0 => X_I_load_3_reg_530,
        din1 => temp_I_reg_518,
        ce => grp_fu_208_ce,
        dout => grp_fu_208_p2);

    fadd_32ns_32ns_32_3_full_dsp_1_U110 : component fft_streaming_fadd_32ns_32ns_32_3_full_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 3,
        din0_WIDTH => 32,
    ...
    fadd_32ns_32ns_32_3_full_dsp_1_U111 : component fft_streaming_fadd_32ns_32ns_32_3_full_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 3,
        din0_WIDTH => 32,
    ...
    fmul_32ns_32ns_32_2_max_dsp_1_U112 : component fft_streaming_fmul_32ns_32ns_32_2_max_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    fmul_32ns_32ns_32_2_max_dsp_1_U113 : component fft_streaming_fmul_32ns_32ns_32_2_max_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    fmul_32ns_32ns_32_2_max_dsp_1_U114 : component fft_streaming_fmul_32ns_32ns_32_2_max_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    fmul_32ns_32ns_32_2_max_dsp_1_U115 : component fft_streaming_fmul_32ns_32ns_32_2_max_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_1 = ap_condition_272)) then
                if ((icmp_ln43_fu_277_p2 = ap_const_lv1_0)) then 
                    j_fu_62 <= select_ln43_5_fu_338_p3;
                elsif ((ap_loop_init = ap_const_logic_1)) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter5 = ap_const_logic_1))) then
                X_I_load_3_reg_530 <= X_I_q0;
                X_R_load_3_reg_524 <= X_R_q0;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_0 = ap_block_pp0_stage0_11001)) then
                ...
                mul7_reg_481 <= grp_fu_226_p2;
                mul8_reg_486 <= grp_fu_232_p2;
                mul9_reg_491 <= grp_fu_238_p2;
    ...
    Out_I_d0 <= add3_reg_551;
    Out_I_d1 <= sub3_reg_541;
    ...
    W_imag6_address0 <= zext_ln43_fu_332_p1(9 - 1 downto 0);

    W_imag6_ce0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0_11001, ap_start_int)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_start_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            W_imag6_ce0 <= ap_const_logic_1;
        else 
            W_imag6_ce0 <= ap_const_logic_0;
        end if; 
    end process;

    W_real14_address0 <= zext_ln43_fu_332_p1(9 - 1 downto 0);

    W_real14_ce0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0_11001, ap_start_int)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_start_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            W_real14_ce0 <= ap_const_logic_1;
        else 
            W_real14_ce0 <= ap_const_logic_0;
        end if; 
    end process;
    ...
    add_ln43_2_fu_306_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_j_2) + unsigned(ap_const_lv8_1));
    add_ln43_fu_283_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_indvar_flatten_load) + unsigned(ap_const_lv10_1));
    add_ln46_fu_370_p2 <= std_logic_vector(unsigned(select_ln43_fu_298_p3) + unsigned(ap_const_lv3_1));
    add_ln53_fu_358_p2 <= std_logic_vector(unsigned(or_ln_fu_350_p3) + unsigned(ap_const_lv10_80));
    ...
    ap_sig_allocacmp_j_2_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, ap_loop_init, j_fu_62, ap_start_int)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_loop_init = ap_const_logic_1) and (ap_start_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    empty_11_fu_312_p1 <= add_ln43_2_fu_306_p2(7 - 1 downto 0);
    empty_fu_265_p1 <= ap_sig_allocacmp_j_2(7 - 1 downto 0);
    ...
    icmp_ln46_fu_292_p2 <= "1" when (ap_sig_allocacmp_t_load = ap_const_lv3_4) else "0";
    or_ln_fu_350_p3 <= (trunc_ln47_fu_346_p1 & select_ln43_5_fu_338_p3);
    p_mid1_fu_316_p3 <= (empty_11_fu_312_p1 & ap_const_lv2_0);
    select_ln43_4_fu_324_p3 <= 
        p_mid1_fu_316_p3 when (icmp_ln46_fu_292_p2(0) = '1') else 
        tmp_5_fu_269_p3;
    select_ln43_5_fu_338_p3 <= 
        add_ln43_2_fu_306_p2 when (icmp_ln46_fu_292_p2(0) = '1') else 
        ap_sig_allocacmp_j_2;
    select_ln43_fu_298_p3 <= 
        ap_const_lv3_0 when (icmp_ln46_fu_292_p2(0) = '1') else 
        ap_sig_allocacmp_t_load;
    tmp_5_fu_269_p3 <= (empty_fu_265_p1 & ap_const_lv2_0);
    trunc_ln47_fu_346_p1 <= select_ln43_fu_298_p3(2 - 1 downto 0);
    zext_ln43_fu_332_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(select_ln43_4_fu_324_p3),64));
