...
entity fft_streaming_fft_stage_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of fft_streaming_fft_stage_1 is 
...
attribute shreg_extract : string;
    ...
    signal mul7_reg_476 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_fu_226_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal mul8_reg_481 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_fu_232_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal mul9_reg_486 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal X_R_load_9_reg_524 : STD_LOGIC_VECTOR (31 downto 0);
    signal X_I_load_9_reg_530 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal sub9_reg_541 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal add9_reg_551 : STD_LOGIC_VECTOR (31 downto 0);
    signal zext_ln43_fu_332_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_pp0_stage0 : BOOLEAN;
    signal t_fu_58 : STD_LOGIC_VECTOR (8 downto 0);
    signal add_ln46_fu_370_p2 : STD_LOGIC_VECTOR (8 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_sig_allocacmp_t_load : STD_LOGIC_VECTOR (8 downto 0);
    signal j_fu_62 : STD_LOGIC_VECTOR (1 downto 0);
    signal select_ln43_17_fu_338_p3 : STD_LOGIC_VECTOR (1 downto 0);
    ...
    signal empty_fu_265_p1 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln46_fu_292_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal add_ln43_8_fu_306_p2 : STD_LOGIC_VECTOR (1 downto 0);
    signal empty_23_fu_312_p1 : STD_LOGIC_VECTOR (0 downto 0);
    signal p_mid1_fu_316_p3 : STD_LOGIC_VECTOR (8 downto 0);
    signal tmp_s_fu_269_p3 : STD_LOGIC_VECTOR (8 downto 0);
    signal select_ln43_16_fu_324_p3 : STD_LOGIC_VECTOR (8 downto 0);
    signal select_ln43_fu_298_p3 : STD_LOGIC_VECTOR (8 downto 0);
    signal trunc_ln47_fu_346_p1 : STD_LOGIC_VECTOR (7 downto 0);
...
begin
    W_real_U : component fft_streaming_fft_stage_1_W_real_ROM_AUTO_1R
    generic map (
        DataWidth => 32,
        AddressRange => 512,
        AddressWidth => 9)
    ...
    W_imag_U : component fft_streaming_fft_stage_1_W_imag_ROM_AUTO_1R
    generic map (
        DataWidth => 32,
        AddressRange => 512,
        AddressWidth => 9)
    ...
    fsub_32ns_32ns_32_3_full_dsp_1_U20 : component fft_streaming_fsub_32ns_32ns_32_3_full_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 3,
        din0_WIDTH => 32,
    ...
    fadd_32ns_32ns_32_3_full_dsp_1_U21 : component fft_streaming_fadd_32ns_32ns_32_3_full_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 3,
        din0_WIDTH => 32,
    ...
    fsub_32ns_32ns_32_3_full_dsp_1_U22 : component fft_streaming_fsub_32ns_32ns_32_3_full_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 3,
        din0_WIDTH => 32,
    ...
    port map (
        clk => ap_clk,
        reset => ap_rst,
        din0 => X_R_load_9_reg_524,
        din1 => temp_R_reg_512,
        ce => grp_fu_204_ce,
        dout => grp_fu_204_p2);

    fsub_32ns_32ns_32_3_full_dsp_1_U23 : component fft_streaming_fsub_32ns_32ns_32_3_full_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 3,
        din0_WIDTH => 32,
    ...
    port map (
        clk => ap_clk,
        reset => ap_rst,
        din0 => X_I_load_9_reg_530,
        din1 => temp_I_reg_518,
        ce => grp_fu_208_ce,
        dout => grp_fu_208_p2);

    fadd_32ns_32ns_32_3_full_dsp_1_U24 : component fft_streaming_fadd_32ns_32ns_32_3_full_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 3,
        din0_WIDTH => 32,
    ...
    fadd_32ns_32ns_32_3_full_dsp_1_U25 : component fft_streaming_fadd_32ns_32ns_32_3_full_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 3,
        din0_WIDTH => 32,
    ...
    fmul_32ns_32ns_32_2_max_dsp_1_U26 : component fft_streaming_fmul_32ns_32ns_32_2_max_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    fmul_32ns_32ns_32_2_max_dsp_1_U27 : component fft_streaming_fmul_32ns_32ns_32_2_max_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    fmul_32ns_32ns_32_2_max_dsp_1_U28 : component fft_streaming_fmul_32ns_32ns_32_2_max_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    fmul_32ns_32ns_32_2_max_dsp_1_U29 : component fft_streaming_fmul_32ns_32ns_32_2_max_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_1 = ap_condition_272)) then
                if ((icmp_ln43_fu_277_p2 = ap_const_lv1_0)) then 
                    j_fu_62 <= select_ln43_17_fu_338_p3;
                elsif ((ap_loop_init = ap_const_logic_1)) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter5 = ap_const_logic_1))) then
                X_I_load_9_reg_530 <= X_I_q0;
                X_R_load_9_reg_524 <= X_R_q0;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_0 = ap_block_pp0_stage0_11001)) then
                ...
                mul7_reg_476 <= grp_fu_220_p2;
                mul8_reg_481 <= grp_fu_226_p2;
                mul9_reg_486 <= grp_fu_232_p2;
                mul_reg_491 <= grp_fu_238_p2;
                or_ln_reg_431_pp0_iter2_reg <= or_ln_reg_431_pp0_iter1_reg;
                or_ln_reg_431_pp0_iter3_reg <= or_ln_reg_431_pp0_iter2_reg;
                sub9_reg_541 <= grp_fu_208_p2;
    ...
    Out_I_d0 <= add9_reg_551;
    Out_I_d1 <= sub9_reg_541;
    ...
    W_imag_address0 <= zext_ln43_fu_332_p1(9 - 1 downto 0);

    W_imag_ce0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0_11001, ap_start_int)
    begin
    ...
    W_real_address0 <= zext_ln43_fu_332_p1(9 - 1 downto 0);

    W_real_ce0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0_11001, ap_start_int)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_start_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    add_ln43_8_fu_306_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_j_8) + unsigned(ap_const_lv2_1));
    add_ln43_fu_283_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_indvar_flatten_load) + unsigned(ap_const_lv10_1));
    add_ln46_fu_370_p2 <= std_logic_vector(unsigned(select_ln43_fu_298_p3) + unsigned(ap_const_lv9_1));
    add_ln53_fu_358_p2 <= std_logic_vector(unsigned(or_ln_fu_350_p3) + unsigned(ap_const_lv10_2));
    ...
    ap_sig_allocacmp_j_8_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, ap_loop_init, j_fu_62, ap_start_int)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_loop_init = ap_const_logic_1) and (ap_start_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_loop_init = ap_const_logic_1) and (ap_start_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            ap_sig_allocacmp_t_load <= ap_const_lv9_0;
        else 
            ap_sig_allocacmp_t_load <= t_fu_58;
        end if; 
    end process;

    empty_23_fu_312_p1 <= add_ln43_8_fu_306_p2(1 - 1 downto 0);
    empty_fu_265_p1 <= ap_sig_allocacmp_j_8(1 - 1 downto 0);
    ...
    icmp_ln46_fu_292_p2 <= "1" when (ap_sig_allocacmp_t_load = ap_const_lv9_100) else "0";
    or_ln_fu_350_p3 <= (trunc_ln47_fu_346_p1 & select_ln43_17_fu_338_p3);
    p_mid1_fu_316_p3 <= (empty_23_fu_312_p1 & ap_const_lv8_0);
    select_ln43_16_fu_324_p3 <= 
        p_mid1_fu_316_p3 when (icmp_ln46_fu_292_p2(0) = '1') else 
        tmp_s_fu_269_p3;
    select_ln43_17_fu_338_p3 <= 
        add_ln43_8_fu_306_p2 when (icmp_ln46_fu_292_p2(0) = '1') else 
        ap_sig_allocacmp_j_8;
    select_ln43_fu_298_p3 <= 
        ap_const_lv9_0 when (icmp_ln46_fu_292_p2(0) = '1') else 
        ap_sig_allocacmp_t_load;
    tmp_s_fu_269_p3 <= (empty_fu_265_p1 & ap_const_lv8_0);
    trunc_ln47_fu_346_p1 <= select_ln43_fu_298_p3(8 - 1 downto 0);
    zext_ln43_fu_332_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(select_ln43_16_fu_324_p3),64));
