...
entity fft_streaming_fft_stage_5 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of fft_streaming_fft_stage_5 is 
...
attribute shreg_extract : string;
    ...
    signal W_real12_address0 : STD_LOGIC_VECTOR (8 downto 0);
    signal W_real12_ce0 : STD_LOGIC;
    signal W_real12_q0 : STD_LOGIC_VECTOR (31 downto 0);
    signal W_imag4_address0 : STD_LOGIC_VECTOR (8 downto 0);
    signal W_imag4_ce0 : STD_LOGIC;
    signal W_imag4_q0 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal mul_reg_481 : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_fu_232_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal mul5_reg_486 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal X_R_load_5_reg_524 : STD_LOGIC_VECTOR (31 downto 0);
    signal X_I_load_5_reg_530 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal sub5_reg_541 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal add5_reg_551 : STD_LOGIC_VECTOR (31 downto 0);
    signal zext_ln43_fu_332_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_pp0_stage0 : BOOLEAN;
    signal t_fu_58 : STD_LOGIC_VECTOR (4 downto 0);
    signal add_ln46_fu_370_p2 : STD_LOGIC_VECTOR (4 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_sig_allocacmp_t_load : STD_LOGIC_VECTOR (4 downto 0);
    signal j_fu_62 : STD_LOGIC_VECTOR (5 downto 0);
    signal select_ln43_9_fu_338_p3 : STD_LOGIC_VECTOR (5 downto 0);
    ...
    signal empty_fu_265_p1 : STD_LOGIC_VECTOR (4 downto 0);
    signal icmp_ln46_fu_292_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal add_ln43_4_fu_306_p2 : STD_LOGIC_VECTOR (5 downto 0);
    signal empty_15_fu_312_p1 : STD_LOGIC_VECTOR (4 downto 0);
    signal p_mid1_fu_316_p3 : STD_LOGIC_VECTOR (8 downto 0);
    signal tmp_s_fu_269_p3 : STD_LOGIC_VECTOR (8 downto 0);
    signal select_ln43_8_fu_324_p3 : STD_LOGIC_VECTOR (8 downto 0);
    signal select_ln43_fu_298_p3 : STD_LOGIC_VECTOR (4 downto 0);
    signal trunc_ln47_fu_346_p1 : STD_LOGIC_VECTOR (3 downto 0);
...
begin
    W_real12_U : component fft_streaming_fft_stage_1_W_real_ROM_AUTO_1R
    generic map (
        DataWidth => 32,
        AddressRange => 512,
        AddressWidth => 9)
    ...
    W_imag4_U : component fft_streaming_fft_stage_1_W_imag_ROM_AUTO_1R
    generic map (
        DataWidth => 32,
        AddressRange => 512,
        AddressWidth => 9)
    ...
    fsub_32ns_32ns_32_3_full_dsp_1_U78 : component fft_streaming_fsub_32ns_32ns_32_3_full_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 3,
        din0_WIDTH => 32,
    ...
    fadd_32ns_32ns_32_3_full_dsp_1_U79 : component fft_streaming_fadd_32ns_32ns_32_3_full_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 3,
        din0_WIDTH => 32,
    ...
    fsub_32ns_32ns_32_3_full_dsp_1_U80 : component fft_streaming_fsub_32ns_32ns_32_3_full_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 3,
        din0_WIDTH => 32,
    ...
    fsub_32ns_32ns_32_3_full_dsp_1_U81 : component fft_streaming_fsub_32ns_32ns_32_3_full_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 3,
        din0_WIDTH => 32,
    ...
    fadd_32ns_32ns_32_3_full_dsp_1_U82 : component fft_streaming_fadd_32ns_32ns_32_3_full_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 3,
        din0_WIDTH => 32,
    ...
    fadd_32ns_32ns_32_3_full_dsp_1_U83 : component fft_streaming_fadd_32ns_32ns_32_3_full_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 3,
        din0_WIDTH => 32,
    ...
    fmul_32ns_32ns_32_2_max_dsp_1_U84 : component fft_streaming_fmul_32ns_32ns_32_2_max_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    fmul_32ns_32ns_32_2_max_dsp_1_U85 : component fft_streaming_fmul_32ns_32ns_32_2_max_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    fmul_32ns_32ns_32_2_max_dsp_1_U86 : component fft_streaming_fmul_32ns_32ns_32_2_max_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    fmul_32ns_32ns_32_2_max_dsp_1_U87 : component fft_streaming_fmul_32ns_32ns_32_2_max_dsp_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    Out_I_d0 <= add5_reg_551;
    Out_I_d1 <= sub5_reg_541;
    ...
    W_imag4_address0 <= zext_ln43_fu_332_p1(9 - 1 downto 0);

    W_imag4_ce0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0_11001, ap_start_int)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_start_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            W_imag4_ce0 <= ap_const_logic_1;
        else 
            W_imag4_ce0 <= ap_const_logic_0;
        end if; 
    end process;

    W_real12_address0 <= zext_ln43_fu_332_p1(9 - 1 downto 0);

    W_real12_ce0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0_11001, ap_start_int)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_start_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            W_real12_ce0 <= ap_const_logic_1;
        else 
            W_real12_ce0 <= ap_const_logic_0;
        end if; 
    end process;
    ...
    add_ln43_4_fu_306_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_j_4) + unsigned(ap_const_lv6_1));
    add_ln43_fu_283_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_indvar_flatten_load) + unsigned(ap_const_lv10_1));
    add_ln46_fu_370_p2 <= std_logic_vector(unsigned(select_ln43_fu_298_p3) + unsigned(ap_const_lv5_1));
    add_ln53_fu_358_p2 <= std_logic_vector(unsigned(or_ln_fu_350_p3) + unsigned(ap_const_lv10_20));
    ...
    ap_sig_allocacmp_j_4_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0, ap_loop_init, j_fu_62, ap_start_int)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_loop_init = ap_const_logic_1) and (ap_start_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    empty_15_fu_312_p1 <= add_ln43_4_fu_306_p2(5 - 1 downto 0);
    empty_fu_265_p1 <= ap_sig_allocacmp_j_4(5 - 1 downto 0);
    ...
    icmp_ln46_fu_292_p2 <= "1" when (ap_sig_allocacmp_t_load = ap_const_lv5_10) else "0";
    or_ln_fu_350_p3 <= (trunc_ln47_fu_346_p1 & select_ln43_9_fu_338_p3);
    p_mid1_fu_316_p3 <= (empty_15_fu_312_p1 & ap_const_lv4_0);
    select_ln43_8_fu_324_p3 <= 
        p_mid1_fu_316_p3 when (icmp_ln46_fu_292_p2(0) = '1') else 
        tmp_s_fu_269_p3;
    select_ln43_9_fu_338_p3 <= 
        add_ln43_4_fu_306_p2 when (icmp_ln46_fu_292_p2(0) = '1') else 
        ap_sig_allocacmp_j_4;
    select_ln43_fu_298_p3 <= 
        ap_const_lv5_0 when (icmp_ln46_fu_292_p2(0) = '1') else 
        ap_sig_allocacmp_t_load;
    tmp_s_fu_269_p3 <= (empty_fu_265_p1 & ap_const_lv4_0);
    trunc_ln47_fu_346_p1 <= select_ln43_fu_298_p3(4 - 1 downto 0);
    zext_ln43_fu_332_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(select_ln43_8_fu_324_p3),64));
