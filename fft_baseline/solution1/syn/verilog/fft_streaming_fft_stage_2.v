...
module fft_streaming_fft_stage_2 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [8:0] W_real9_address0;
reg    W_real9_ce0;
wire   [31:0] W_real9_q0;
wire   [8:0] W_imag1_address0;
reg    W_imag1_ce0;
wire   [31:0] W_imag1_q0;
...
reg   [31:0] mul5_reg_481;
wire   [31:0] grp_fu_232_p2;
reg   [31:0] mul_reg_486;
...
wire   [2:0] add_ln43_7_fu_306_p2;
wire   [1:0] empty_21_fu_312_p1;
wire   [8:0] p_mid1_fu_316_p3;
wire   [8:0] tmp_s_fu_269_p3;
wire   [8:0] select_ln43_14_fu_324_p3;
wire   [7:0] select_ln43_fu_298_p3;
wire   [6:0] trunc_ln47_fu_346_p1;
...
fft_streaming_fsub_32ns_32ns_32_3_full_dsp_1 #(
    ...
    .din1_WIDTH( 32 ),
    .dout_WIDTH( 32 ))
fsub_32ns_32ns_32_3_full_dsp_1_U36(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(mul4_reg_476),
    .din1(mul5_reg_481),
...
fft_streaming_fadd_32ns_32ns_32_3_full_dsp_1 #(
    ...
    .din1_WIDTH( 32 ),
    .dout_WIDTH( 32 ))
fadd_32ns_32ns_32_3_full_dsp_1_U37(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(mul_reg_486),
    .din1(mul6_reg_491),
...
fft_streaming_fsub_32ns_32ns_32_3_full_dsp_1 #(
    ...
    .din1_WIDTH( 32 ),
    .dout_WIDTH( 32 ))
fsub_32ns_32ns_32_3_full_dsp_1_U38(
    .clk(ap_clk),
    .reset(ap_rst),
...
fft_streaming_fsub_32ns_32ns_32_3_full_dsp_1 #(
    ...
    .din1_WIDTH( 32 ),
    .dout_WIDTH( 32 ))
fsub_32ns_32ns_32_3_full_dsp_1_U39(
    .clk(ap_clk),
    .reset(ap_rst),
...
fft_streaming_fadd_32ns_32ns_32_3_full_dsp_1 #(
    ...
    .din1_WIDTH( 32 ),
    .dout_WIDTH( 32 ))
fadd_32ns_32ns_32_3_full_dsp_1_U40(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(X_R_load_8_reg_524),
    .din1(temp_R_reg_512),
...
assign Out_I_d0 = add8_reg_551;

assign Out_I_d1 = sub8_reg_541;
...
assign W_imag1_address0 = zext_ln43_fu_332_p1;

assign W_real9_address0 = zext_ln43_fu_332_p1;
...
assign add_ln43_7_fu_306_p2 = (ap_sig_allocacmp_j_7 + 3'd1);

assign add_ln43_fu_283_p2 = (ap_sig_allocacmp_indvar_flatten_load + 10'd1);

assign add_ln46_fu_370_p2 = (select_ln43_fu_298_p3 + 8'd1);

assign add_ln53_fu_358_p2 = (or_ln_fu_350_p3 + 10'd4);
...
assign empty_21_fu_312_p1 = add_ln43_7_fu_306_p2[1:0];

assign empty_fu_265_p1 = ap_sig_allocacmp_j_7[1:0];

assign icmp_ln43_fu_277_p2 = ((ap_sig_allocacmp_indvar_flatten_load == 10'd512) ? 1'b1 : 1'b0);

assign icmp_ln46_fu_292_p2 = ((ap_sig_allocacmp_t_load == 8'd128) ? 1'b1 : 1'b0);

assign or_ln_fu_350_p3 = {{trunc_ln47_fu_346_p1}, {select_ln43_15_fu_338_p3}};

assign p_mid1_fu_316_p3 = {{empty_21_fu_312_p1}, {7'd0}};

assign select_ln43_14_fu_324_p3 = ((icmp_ln46_fu_292_p2[0:0] == 1'b1) ? p_mid1_fu_316_p3 : tmp_s_fu_269_p3);

assign select_ln43_15_fu_338_p3 = ((icmp_ln46_fu_292_p2[0:0] == 1'b1) ? add_ln43_7_fu_306_p2 : ap_sig_allocacmp_j_7);

assign select_ln43_fu_298_p3 = ((icmp_ln46_fu_292_p2[0:0] == 1'b1) ? 8'd0 : ap_sig_allocacmp_t_load);

assign tmp_s_fu_269_p3 = {{empty_fu_265_p1}, {7'd0}};

assign trunc_ln47_fu_346_p1 = select_ln43_fu_298_p3[6:0];

assign zext_ln43_fu_332_p1 = select_ln43_14_fu_324_p3;
...
endmodule //fft_streaming_fft_stage_2
