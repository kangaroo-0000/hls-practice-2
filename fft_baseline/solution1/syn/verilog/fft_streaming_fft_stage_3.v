...
module fft_streaming_fft_stage_3 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [8:0] W_real10_address0;
reg    W_real10_ce0;
wire   [31:0] W_real10_q0;
wire   [8:0] W_imag2_address0;
reg    W_imag2_ce0;
wire   [31:0] W_imag2_q0;
...
reg   [31:0] mul1_reg_476;
wire   [31:0] grp_fu_226_p2;
reg   [31:0] mul2_reg_481;
...
wire   [3:0] add_ln43_6_fu_306_p2;
wire   [2:0] empty_19_fu_312_p1;
wire   [8:0] p_mid1_fu_316_p3;
wire   [8:0] tmp_s_fu_269_p3;
wire   [8:0] select_ln43_12_fu_324_p3;
wire   [6:0] select_ln43_fu_298_p3;
wire   [5:0] trunc_ln47_fu_346_p1;
...
fft_streaming_fsub_32ns_32ns_32_3_full_dsp_1 #(
    ...
    .din1_WIDTH( 32 ),
    .dout_WIDTH( 32 ))
fsub_32ns_32ns_32_3_full_dsp_1_U50(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(mul1_reg_476),
    .din1(mul2_reg_481),
...
fft_streaming_fadd_32ns_32ns_32_3_full_dsp_1 #(
    ...
    .din1_WIDTH( 32 ),
    .dout_WIDTH( 32 ))
fadd_32ns_32ns_32_3_full_dsp_1_U51(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(mul_reg_486),
    .din1(mul3_reg_491),
...
fft_streaming_fsub_32ns_32ns_32_3_full_dsp_1 #(
    ...
    .din1_WIDTH( 32 ),
    .dout_WIDTH( 32 ))
fsub_32ns_32ns_32_3_full_dsp_1_U52(
    .clk(ap_clk),
    .reset(ap_rst),
...
fft_streaming_fsub_32ns_32ns_32_3_full_dsp_1 #(
    ...
    .din1_WIDTH( 32 ),
    .dout_WIDTH( 32 ))
fsub_32ns_32ns_32_3_full_dsp_1_U53(
    .clk(ap_clk),
    .reset(ap_rst),
...
fft_streaming_fadd_32ns_32ns_32_3_full_dsp_1 #(
    ...
    .din1_WIDTH( 32 ),
    .dout_WIDTH( 32 ))
fadd_32ns_32ns_32_3_full_dsp_1_U55(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(X_I_load_7_reg_530),
    .din1(temp_I_reg_518),
...
assign Out_I_d0 = add7_reg_551;

assign Out_I_d1 = sub7_reg_541;
...
assign W_imag2_address0 = zext_ln43_fu_332_p1;

assign W_real10_address0 = zext_ln43_fu_332_p1;
...
assign add_ln43_6_fu_306_p2 = (ap_sig_allocacmp_j_6 + 4'd1);

assign add_ln43_fu_283_p2 = (ap_sig_allocacmp_indvar_flatten_load + 10'd1);

assign add_ln46_fu_370_p2 = (select_ln43_fu_298_p3 + 7'd1);

assign add_ln53_fu_358_p2 = (or_ln_fu_350_p3 + 10'd8);
...
assign empty_19_fu_312_p1 = add_ln43_6_fu_306_p2[2:0];

assign empty_fu_265_p1 = ap_sig_allocacmp_j_6[2:0];

assign icmp_ln43_fu_277_p2 = ((ap_sig_allocacmp_indvar_flatten_load == 10'd512) ? 1'b1 : 1'b0);

assign icmp_ln46_fu_292_p2 = ((ap_sig_allocacmp_t_load == 7'd64) ? 1'b1 : 1'b0);

assign or_ln_fu_350_p3 = {{trunc_ln47_fu_346_p1}, {select_ln43_13_fu_338_p3}};

assign p_mid1_fu_316_p3 = {{empty_19_fu_312_p1}, {6'd0}};

assign select_ln43_12_fu_324_p3 = ((icmp_ln46_fu_292_p2[0:0] == 1'b1) ? p_mid1_fu_316_p3 : tmp_s_fu_269_p3);

assign select_ln43_13_fu_338_p3 = ((icmp_ln46_fu_292_p2[0:0] == 1'b1) ? add_ln43_6_fu_306_p2 : ap_sig_allocacmp_j_6);

assign select_ln43_fu_298_p3 = ((icmp_ln46_fu_292_p2[0:0] == 1'b1) ? 7'd0 : ap_sig_allocacmp_t_load);

assign tmp_s_fu_269_p3 = {{empty_fu_265_p1}, {6'd0}};

assign trunc_ln47_fu_346_p1 = select_ln43_fu_298_p3[5:0];

assign zext_ln43_fu_332_p1 = select_ln43_12_fu_324_p3;
...
endmodule //fft_streaming_fft_stage_3
